...
\begin{figure*}
\centerline{\includegraphics[width=\textwidth]{analysis/sizes_tweaked.pdf}}
\caption{
...
\begin{figure*}
\centerline{\includegraphics[width=\textwidth]{analysis/relative_sizes_tweaked.pdf}}
...
\begin{figure*}
\centerline{\includegraphics[width=\textwidth]{analysis/comp_decomp_time_tweaked.pdf}}
\caption{
...
To elucidate the trade-off made between space and correctness, we performed
...
40\% (Figure \ref{fig:relative_sizes}). While limited in scope, for certain
