...
\begin{table}
\begin{tabular}{lllr}
 \textit{Accession Number} & \textit{Description} & \textit{Read Length} & \textit{Size (GB)} \\ \hline
SRR400039                 & Whole Genome      &   & 67.6 \\
SRR125858                 & Exome             &   & 55.2 \\
SRR372816                 & Runx2 ChIP-Seq    &   & 14.6 \\
ERR030867                 & Total RNA         &   & 19.5 \\
ERR030894                 & mRNA              &   & 16.4 \\
SRR359032                 & Metagenomic DNA   &   &  8.9 \\
\end{tabular}
\caption{
...
\begin{figure*}
\begin{center}
\includegraphics[width=\textwidth]{sizes_tweaked_fixed.eps}
\end{center}
\caption{
...
\begin{figure*}
\centerline{\includegraphics[width=\textwidth]{relative_sizes_tweaked.eps}}
...
\begin{figure*}
\centerline{\includegraphics[width=\textwidth]{comp_decomp_time_tweaked.eps}}
\caption{
